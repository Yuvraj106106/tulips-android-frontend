          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.row}>
                <View>
                  <Text style={styles.rowLabel}>{settings.user?.name || 'Guest'}</Text>
                  <Text style={styles.rowSubLabel}>{settings.user?.email || 'No email'}</Text>
                  <Text style={styles.rowSubLabel}>{settings.user?.phoneNumber || 'No phone'}</Text>
                </View>
              </View>
